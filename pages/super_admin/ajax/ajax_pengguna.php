            ...
            while ($r = $query->fetch_array())
            {
                ...
                $nestedData['id_user']             =  '
                                                    <center>
                                                        ...
                                                        <button type="button" class="btn btn-block btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete" value='.$id_user.' onclick="hapusdata(this.value)"><i class="fa fa-trash"></i> Hapus</button>
                                                    </center>';
                $data[] = $nestedData;
                $no++;
            }

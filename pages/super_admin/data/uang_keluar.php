                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    ...
                                    <a class="btn btn-sm btn-rounded btn-danger" href="proses/proses_uang_keluar_hapus.php?id_uang_keluar=<?= $id_uang_keluar ?>"  onclick="return confirm('Anda yakin menghapus data uang keluar <?= $nama_barang ?> ')">Hapus</a>
                                    <!-- <button type="button" class="btn btn-group btn-success btn-sm" value='<?php echo $id_uang_keluar ?>' onclick="ubahdata(this.value)" data-toggle="modal" data-target="#ubah">Edit</button> -->

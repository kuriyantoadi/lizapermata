...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <span class="brand-text font-weight-light"><?= $get_nama_lengkap_session_header?> / Admin</span>
    </a>
    ...
    <div class="sidebar">
     ...
     <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- </li>
           <li class="nav-item">
            <a href="index.php?hal=pengeluaran" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index.php?hal=laporan_excel" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Laporan Transaksi XLS</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="index.php?hal=laporan_xls_uang_keluar" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Uang Keluar XLS</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="index.php?hal=supir" class="nav-link">

...
if(isset($_POST['tambah'])){
  ...
  if(!preg_match($var,$harga)) {
    ...
    $sql = mysqli_query($koneksi, "INSERT INTO produk values('','$nama_produk','$kategori_produk','$harga','0','$status_aktif','$key_produk','$id_session','$tgltamp')");
      if ($sql) { 
...
if(isset($_POST['ubah'])){
    ...
    $sql = mysqli_query($koneksi, "UPDATE produk SET nama_produk='$nama_produk',id_kategori_produk='$kategori_produk',harga_produk='$harga_produk',status_produk='$status_aktif' WHERE key_produk='$key_produk'");
      if ($sql) { 
